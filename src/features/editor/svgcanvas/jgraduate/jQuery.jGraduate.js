 ...
 */
export const jGraduateDefaults =
 ...
 * @returns {external:jQuery}
 */
export function jGraduateMethod(
  elem,
  options,
  okCallback,
  cancelCallback,
  ...
  $this.innerHTML = `<ul class="jGraduate_tabs">
      <li class="jGraduate_tab_color jGraduate_tab_current" id="jGraduate_tab_color" data-type="col">${i18next.t(
        "config.jgraduate_solid_color"
      )}</li>
      <li class="jGraduate_tab_lingrad" id="jGraduate_tab_lingrad" data-type="lg">${i18next.t(
        "config.jgraduate_linear_gradient"
      )}</li>
      <li class="jGraduate_tab_radgrad" id="jGraduate_tab_radgrad" data-type="rg">${i18next.t(
        "config.jgraduate_radial_gradient"
      )}</li>
    </ul>
  ...
  const html = `<div id="${id}_jGraduate_Swatch" class="jGraduate_Swatch">
      ...
      <div class="jGraduate_Form jGraduate_Points jGraduate_lg_field">
        <div class="jGraduate_StopSection">
          <label class="jGraduate_Form_Heading">${i18next.t(
            "config.jgraduate_begin_point"
          )}</label>
          <div class="jGraduate_Form_Section">
            <label>x:</label>
              <input type="text" id="${id}_jGraduate_x1" size="3" title="${i18next.t(
    "config.jgraduate_enter_starting_x"
  )}"/>
            <label>y:</label>
            <input type="text" id="${id}_jGraduate_y1" size="3" title="${i18next.t(
    "config.jgraduate_enter_starting_y"
  )}"/>
          </div>
        </div>
        <div class="jGraduate_StopSection">
          <label class="jGraduate_Form_Heading">${i18next.t(
            "config.jgraduate_end_point"
          )}</label>
          <div class="jGraduate_Form_Section">
            <label>x:</label>
            <input type="text" id="${id}_jGraduate_x2" size="3" title="${i18next.t(
    "config.jgraduate_enter_ending_x"
  )}"/>
            <label>y:</label>
            <input type="text" id="${id}_jGraduate_y2" size="3" title="${i18next.t(
    "config.jgraduate_enter_ending_y"
  )}"/>
          </div>
        </div>
      </div>
      <div class="jGraduate_Form jGraduate_Points jGraduate_rg_field">
        <div class="jGraduate_StopSection">
          <label class="jGraduate_Form_Heading">${i18next.t(
            "config.jgraduate_center_point"
          )}</label>
          <div class="jGraduate_Form_Section">
            <label>x:</label>
            <input type="text" id="${id}_jGraduate_cx" size="3" title="${i18next.t(
    "config.jgraduate_enter_value_x"
  )}"/>
            <label>y:</label>
            <input type="text" id="${id}_jGraduate_cy" size="3" title="${i18next.t(
    "config.jgraduate_enter_value_y"
  )}"/>
          </div>
        </div>
        <div class="jGraduate_StopSection">
          <label class="jGraduate_Form_Heading">${i18next.t(
            "config.jgraduate_focal_point"
          )}</label>
          <div class="jGraduate_Form_Section">
            <label>${i18next.t(
              "config.jgraduate_match_center"
            )} <input type="checkbox" checked="checked" id="${id}_jGraduate_match_ctr"/></label><br/>
            <label>x:</label>
            <input type="text" id="${id}_jGraduate_fx" size="3" title="${i18next.t(
    "config.jgraduate_enter_focal_x"
  )}"/>
            <label>y:</label>
            <input type="text" id="${id}_jGraduate_fy" size="3" title="${i18next.t(
    "config.jgraduate_enter_focal_y"
  )}"/>
          </div>
        </div>
      </div>
      <div class="jGraduate_StopSection jGraduate_SpreadMethod">
        <label class="jGraduate_Form_Heading">${i18next.t(
          "config.jgraduate_spread_method"
        )}</label>
        <div class="jGraduate_Form_Section">
          <select class="jGraduate_spreadMethod" id="jGraduate_spreadMethod">
            <option value=pad selected>${i18next.t(
              "properties.jgraduate_pad"
            )}</option>
            <option value=reflect>${i18next.t(
              "properties.jgraduate_reflect"
            )}</option>
            <option value=repeat>${i18next.t(
              "properties.jgraduate_repeat"
            )}</option>
          </select>
        </div>
      </div>
      <div class="jGraduate_Form">
        <div class="jGraduate_Slider jGraduate_RadiusField jGraduate_rg_field">
          <label class="prelabel">${i18next.t(
            "config.jgraduate_radius"
          )}</label>
          <div id="${id}_jGraduate_Radius" class="jGraduate_SliderBar jGraduate_Radius" title="${i18next.t(
    "config.jgraduate_set_radius"
  )}">
            <img id="${id}_jGraduate_RadiusArrows" class="jGraduate_RadiusArrows" src="${
    $settings.images.clientPath
        ...
        <div class="jGraduate_Slider jGraduate_EllipField jGraduate_rg_field">
          ...
          <div id="${id}_jGraduate_Ellip" class="jGraduate_SliderBar jGraduate_Ellip" title="${i18next.t(
    "config.jgraduate_set_ellip"
  )}">
            <img id="${id}_jGraduate_EllipArrows" class="jGraduate_EllipArrows" src="${
    $settings.images.clientPath
  }rangearrows2.gif">
          </div>
        ...
        <div class="jGraduate_Slider jGraduate_AngleField jGraduate_rg_field">
          ...
          <div id="${id}_jGraduate_Angle" class="jGraduate_SliderBar jGraduate_Angle" title="${i18next.t(
    "config.jgraduate_set_angle"
  )}">
            <img id="${id}_jGraduate_AngleArrows" class="jGraduate_AngleArrows" src="${
    $settings.images.clientPath
  }rangearrows2.gif">
          </div>
          <label><input type="text" id="${id}_jGraduate_AngleInput" size="3" value="0"/>${i18next.t(
    "config.jgraduate_deg"
  )}</label>
        </div>
        <div class="jGraduate_Slider jGraduate_OpacField">
          <label class="prelabel">${i18next.t("config.jgraduate_opac")}</label>
          <div id="${id}_jGraduate_Opac" class="jGraduate_SliderBar jGraduate_Opac" title="${i18next.t(
    "config.jgraduate_set_opac"
  )}">
            <img id="${id}_jGraduate_OpacArrows" class="jGraduate_OpacArrows" src="${
    $settings.images.clientPath
  }rangearrows2.gif">
          </div>
      ...
      <div class="jGraduate_OkCancel">
        <input type="button" id="${id}_jGraduate_Ok" class="jGraduate_Ok" value="${i18next.t(
    "common.ok"
  )}"/>
        <input type="button" id="${id}_jGraduate_Cancel" class="jGraduate_Cancel" value="${i18next.t(
    "common.cancel"
  )}"/>
      </div>`;
      ...
      switch ($settings.newstop) {
        ...
        case "inverse": {
          ...
          for (let i = 0; i < 6; i += 2) {
            ...
            let inv = (255 - Number.parseInt(color.substr(i, 2), 16)).toString(
              16
            );
  ...
  for (const [, attr] of [
    ...
    attrInput[attr].addEventListener("change", (evt) =>
      onAttrChangeHandler(evt, attr, isRadial)
    );
  ...
  function mkStop(n, colr, opac, sel, stopElem) {
    ...
    const pickerD =
      "M-6.2,0.9c3.6-4,6.7-4.3,6.7-12.4c-0.2,7.9," +
    ...
    path.addEventListener("dblclick", function () {
      ...
      const jqPickerElem = $this.querySelector(
  ...
  spreadMethodOpt.setAttribute(
    "value",
    curGradient.getAttribute("spreadMethod") || "pad"
  );
  ...
  // bind GUI elements
  svgEditor.$click(
    $this.querySelector("#" + id + "_jGraduate_Ok"),
    function () {
  ...
  svgEditor.$click(
    $this.querySelector("#" + id + "_jGraduate_Cancel"),
    cancelClicked
  );
  ...
  $this
    .querySelector("#" + id + "_jGraduate_match_ctr")
    .addEventListener("change", onMatchCtrHandler);
  stops = curGradient.getElementsByTagNameNS(ns.svg, "stop");
  ...
  const setSlider = function (e) {
    ...
    let x =
      ...
      left -
      Number.parseInt(
        getComputedStyle(divi, null).getPropertyValue("border-left-width")
      );
  ...
  color =
    $this.paint.solidColor === "none" ? "" : $this.paint.solidColor + thisAlpha;
  ...
  const onTabsClickHandler = (e) => {
    ...
    if (type === "rg" || type === "lg") {
      ...
      const t1Fileds = $this.querySelectorAll(
        ".jGraduate_" + (type === "lg" ? "rg" : "lg") + "_field"
      );
      [].forEach.call(t1Fileds, function (tFiled) {
        tFiled.style.display = "none";
      });
      $this
        .querySelectorAll("#" + id + "_jgraduate_rect")[0]
      ...
      const newGrad = $this.querySelectorAll(
        "#" + id + "_" + type + "_jgraduate_grad"
      )[0];
      ...
      showFocus =
        ...
        !(cx === fx && cy === fy);
      const jQfocusCoord = $this.querySelectorAll(
        "#" + id + "_jGraduate_focusCoord"
      );
