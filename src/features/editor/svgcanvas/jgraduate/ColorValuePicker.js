  ...
  constructor(picker, color, bindedHex, alphaPrecision) {
    ...
    function keyDown(e) {
      if (
        e.target.value === "" &&
        e.target !== hex &&
        ((bindedHex && e.target !== bindedHex) || !bindedHex)
      )
        return undefined;
      ...
      switch (e.target) {
        case red:
          switch (e.keyCode) {
            case 38:
              red.value = setValueInRange.call(
                that,
                (red.value << 0) + 1,
                0,
                255
        ...
        case green:
          switch (e.keyCode) {
            case 38:
              green.value = setValueInRange.call(
                that,
                (green.value << 0) + 1,
                0,
                255
        ...
        case blue:
          switch (e.keyCode) {
            case 38:
              blue.value = setValueInRange.call(
                that,
                (blue.value << 0) + 1,
                0,
                255
        ...
        case alpha:
          switch (e.keyCode) {
            case 38:
              alpha.value = setValueInRange.call(
                that,
                Number.parseFloat(alpha.value) + 1,
                0,
                100
              );
              color.val(
                "a",
                toFixedNumeric((alpha.value * 255) / 100, alphaPrecision),
                e.target
              );
              return false;
            case 40:
        ...
        case hue:
          switch (e.keyCode) {
            case 38:
              hue.value = setValueInRange.call(
                that,
                (hue.value << 0) + 1,
                0,
                360
        ...
        case saturation:
          switch (e.keyCode) {
            case 38:
              saturation.value = setValueInRange.call(
                that,
        ...
        case value:
          switch (e.keyCode) {
            case 38:
              value.value = setValueInRange.call(
                that,
                (value.value << 0) + 1,
                0,
                100
    ...
    function keyUp(e) {
      ...
      switch (e.target) {
        ...
        case hex:
          ...
          break;
        case bindedHex:
          bindedHex.value = bindedHex.value
            .replace(/[^a-fA-F\d]/g, "")
            .toLowerCase()
            .substring(0, 6);
          ...
          color.val(
            "hex",
            bindedHex.value !== "" ? bindedHex.value : null,
            e.target
          );
          break;
        case ahex:
          ahex.value = ahex.value
            .replace(/[^a-fA-F\d]/g, "")
            .toLowerCase()
            .substring(0, 2);
          color.val(
            "a",
            ahex.value ? Number.parseInt(ahex.value, 16) : null,
            e.target
          );
          break;
      }
    ...
    function colorChanged(ui, context) {
      ...
      if (alpha && context !== alpha)
        alpha.value = all
          ? toFixedNumeric((all.a * 100) / 255, alphaPrecision)
          : "";
      ...
      if (
        context !== hex &&
        ((bindedHex && context !== bindedHex) || !bindedHex)
      )
        hex.value = all ? all.hex : "";
      if (bindedHex && context !== bindedHex && context !== hex)
        bindedHex.value = all ? all.hex : "";
      if (ahex && context !== ahex)
        ahex.value = all ? all.ahex.substring(6) : "";
    }
    /**
